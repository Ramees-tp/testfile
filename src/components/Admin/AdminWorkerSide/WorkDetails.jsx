    ...
    <div>
       ...
       <main className="p-6 sm:p-10 space-y-6">
        ...
        <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
          <div className="mr-6">
            <h1 className="sm:text-4xl text-3xl font-semibold mb-2">Work Reports</h1>
            <h2 className="text-gray-600 ml-0.5">All completed and pending works</h2>
          </div>
        ...
        <section className="grid md:grid-cols-2 xl:grid-cols-2 gap-6">
          {/* Student Statistics */}
          <div className="flex items-center tm:p-8 p-4 bg-white shadow rounded-lg cursor-pointer" onClick={() => handleButtonClick(1)}>
            ...
            <div>
              <span className="block tm:text-2xl text-lg font-bold">Accepted Works By workers</span>
            </div>
          </div>
          ...
          <div onClick={() => handleButtonClick(2)} className="flex items-center p-8 bg-white shadow rounded-lg cursor-pointer">
            ...
            <div>
              <span className="block tm:text-2xl text-lg font-bold">Completed workers</span>
            </div>
          </div>
